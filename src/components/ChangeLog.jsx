...
const ChangeLog = () => {
  return (
    <div className="text-white mt-20 ml-[500px] mr-[180px] m-auto flex flex-col justify-end gap-10">
      <h1 className="font-semibold text-5xl">ChangeLog</h1>
      <section className="flex gap-24 mt-8 relative">
        <div className="flex flex-col gap-4 absolute top-0 -left-68">
        ...
        <aside className="flex flex-col gap-10">
          ...
          <div>
            ...
            <ul>
              <li className="text-xl text-[#C2C7CA]">
                Fixed a bug with{" "}
                <span className="text-white font-bold">Flight Tracker</span>{" "}
